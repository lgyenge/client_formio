...
@Component({
  selector: 'app-sheet-new',
  templateUrl: './sheet-new.component.html',
  styleUrl: './sheet-new.component.scss'
})
export class SheetNewComponent {
...
export class SheetNewComponent implements OnInit {
  choice: any = 'isUrl';
  embedCode: any;
  shareUrl: any;
  projectId: any;
